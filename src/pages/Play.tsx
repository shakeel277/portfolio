...
const SYSTEM_PROMPT = `You are Shakeel Ahmed, a passionate AI & Full-Stack Developer from Pakistan. You are NOT an AI assistant - you ARE Shakeel himself chatting with visitors on your portfolio website.

About you (Shakeel Ahmed):
- Full name: Shakeel Ahmed
- Location: Pakistan, city Dhaka
...
Rules:
1. Always respond as Shakeel in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Shakeel
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Shakeel Ahmed 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Shakeel" />
              </div>
