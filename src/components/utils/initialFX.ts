...
export function initialFX() {
  ...
  // Hero greeting + name animate as SINGLE elements via CSS (see index.css)
  // to guarantee no character overlap / wrapping issues.
  // GSAP splitter is used only for the .landing-info h3 subtitle.
  const selectors = [".landing-info h3"];
